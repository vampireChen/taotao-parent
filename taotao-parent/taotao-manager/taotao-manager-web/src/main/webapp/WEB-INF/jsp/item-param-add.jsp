...
<div  class="itemParamAddTemplate" style="display: none;">
	<li class="param">
		<ul>
			<li>
				<input class="easyui-textbox" style="width: 150px;" name="group"/>&nbsp;<a href="javascript:void(0)" class="easyui-linkbutton addParam"  title="添加参数" data-options="plain:true,iconCls:'icon-add'"></a>&nbsp;<a href="javascript:void(0)" class="easyui-linkbutton delGroup" title="删除" data-options="plain:true,iconCls:'icon-cancel'"></a>
			</li>
			<li>
